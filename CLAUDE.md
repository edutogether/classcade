...
**2026-08-26 대표 결정: 보류.** 되살리기(A, 단 App Check+속도제한 선행 필요)와 완전 삭제(B, 로딩 780KB→250KB 절감) 둘 다 지금 하지 않는다 — 모바일·PC 에셋이 완성되는 시점에 위 LOCKED 섹션의 3가지 UX 후보 중 하나로 재설계하며 대표와 함께 다시 정한다. **이 세션은 그때까지 페어링 관련 코드를 임의로 손대지 않는다.**
