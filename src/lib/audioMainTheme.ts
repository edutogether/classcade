import { BGM_MANIFEST } from '../data/audioManifest'
import { DEFAULT_BGM_VOLUME, clampBgmVolume } from './audioController'
...
export function beginMainThemeReveal(enabled: boolean, volume: number) {
  ...
  if (!enabled || !getHasAudioUserGesture() || mainThemeState !== 'idle') return
