...
const TEXT_X = 866
/* Dots sit just above the bar and the subtitle just below it, each 19art-px from the
   frame — matching gaps so the bar reads as evenly bracketed top and bottom. */
const TEXT = {
  title: { x: TEXT_X, y: 455 },
  dots: { x: TEXT_X, y: 512 },
  subtitle: { x: TEXT_X, y: 561 },
}
