...
export function restorePairingJourney(payload: PairingPayload, audio: AudioSettings): JourneyState {
  return { version: 3, stage: 'nbti_result', questionIndex: 15, answers: { ...payload.answers }, resultCode: payload.resultCode, audio, updatedAt: new Date().toISOString(), resumeStage: null }
}
